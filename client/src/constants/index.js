export const surpriseMePrompts = [
  "Create an image of a bicycle made entirely out of flowers.",
  "Generate an image of a mermaid sitting on a rock in the middle of the ocean.",
  "Create an image of a giant elephant standing in the middle of a city.",
  "Generate an image of a treehouse that's surrounded by a magical forest.",
  "Create an image of a panda riding a unicycle.",
  "Generate an image of a house that's shaped like a shoe.",
  "Create an image of a hot air balloon that's shaped like a giant teapot.",
  "Generate an image of a castle made entirely out of ice.",
  "Create an image of a dragon sleeping in a cozy bed.",
  "Generate an image of a train that's traveling through a desert landscape.",
  "Create an image of a turtle wearing a superhero costume.",
  "Generate an image of a city that's floating in the clouds.",
